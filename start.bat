...
start "Code Quest Backend" cmd /c "cd /d %cd% && set PYTHONPATH=%cd% && venv\Scripts\python -m uvicorn backend.main:app --port 8000"

echo [INFO] 启动前端服务 (端口 5174)...
start "Code Quest Frontend" cmd /c "cd /d %cd%\frontend && npm run dev"
